...
public class Environment extends EnvironmentDescription
{
    ...
    public Environment() {
        ...
        final Utility chaos = new Utility();
        this.addMinerals(chaos.mathRand(10, 15));
        this.addMountains(chaos.mathRand(15, 30));
    }
    ...
    private void buildBorderWalls() {
        final Wall w1 = new Wall(Coordinates.setCoords(0, 12), 25.0f, 2.0f, (EnvironmentDescription)this);
        w1.setColor(new Color3f(Color.DARK_GRAY));
        w1.rotate90(1);
        this.add((Object)w1);
        final Wall w2 = new Wall(Coordinates.setCoords(0, -12), 25.0f, 2.0f, (EnvironmentDescription)this);
        w2.setColor(new Color3f(Color.DARK_GRAY));
        w2.rotate90(1);
        this.add((Object)w2);
        final Wall w3 = new Wall(Coordinates.setCoords(12, 0), 25.0f, 2.0f, (EnvironmentDescription)this);
        w3.setColor(new Color3f(Color.DARK_GRAY));
        this.add((Object)w3);
        final Wall w4 = new Wall(Coordinates.setCoords(-12, 0), 25.0f, 2.0f, (EnvironmentDescription)this);
    ...
    private void addMinerals(final int totNumBox) {
        for (int currNumBox = 0; currNumBox < totNumBox; ++currNumBox) {
            final Vector3d coords = Coordinates.getRandCoord();
    ...
    private void addMountains(final int totNumBox) {
        for (int currNumBox = 0; currNumBox < totNumBox; ++currNumBox) {
            final Utility shape = new Utility();
            final Vector3d coords = Coordinates.getRandCoord();
            final Box mountains = new Box(coords, new Vector3f((float)shape.mathRand(1, 3), 1.0f, (float)shape.mathRand(2, 4)), (EnvironmentDescription)this);
